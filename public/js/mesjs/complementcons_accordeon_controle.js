...
//	            $("#erreur_taille").fadeIn().text("Max: 250cm").css({"color":"#ff5b5b","padding":" 0 10px 0 10px","margin-top":"-10px","font-size":"13px","font-style":"italic"});
//	            temoinTaille = 1;
//	    	} 
//	    	else{
...
//	    });
	    ...
	    $("#poids").blur(function(){
	    	...
	    	if(isNaN(valeur/1) || valeur > 300 || valeur == ""){
				...
				$("#erreur_poids").fadeIn().text("Max: 300kg").css({"color":"#ff5b5b","padding":" 0 10px 0 10px","margin-top":"-10px","font-size":"13px","font-style":"italic"});
				temoinPoids = 2;
	    	} 
	    	else{
	    ...
	    $("#temperature").blur(function(){
	    	...
	    	if(isNaN(valeur/1) || valeur > 45 || valeur < 34  || valeur == ""){
	    		...
	    		$("#erreur_temperature").fadeIn().text("Min: 34Â°C, Max: 45Â°C").css({"color":"#ff5b5b","padding":" 0 10px 0 10px","margin-top":"-10px","font-size":"13px","font-style":"italic"});
				temoinTemperature = 3;
	    	} 
	    	else{
...
//				$("#erreur_pouls").fadeIn().text("Max: 150 battements").css({"color":"#ff5b5b","padding":" 0 10px 0 10px","margin-top":"-10px","font-size":"13px","font-style":"italic"});
//				temoinPouls = 4;
//			}else{
...
//	    });
	    ...
	    $("#tensionmaximale").blur(function(){
			...
			if(isNaN(valeur/1) || valeur > 300 || valeur == ""){
	    		...
	    		$("#erreur_tensionmaximale").fadeIn().text("300mmHg").css({"color":"#ff5b5b","padding":" 0 10px 0 10px","margin-top":"-10px","font-size":"13px","font-style":"italic"});
	    ...
	    $("#tensionminimale").blur(function(){
			...
			if(isNaN(valeur/1) || valeur > 200 || valeur == ""){
	    		...
	    		$("#erreur_tensionminimale").fadeIn().text("200mmHg").css({"color":"#ff5b5b","padding":" 0 10px 0 105px","margin-top":"-10px","font-size":"13px","font-style":"italic"});
...
//-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*--*-*-*-*--*-*-*-*-*-**--*-**-*--**-*-*-*-*-*-*-*-*-*-*-*-*-*--**-*-*-*-*-	
	...
	$("#terminer2, #terminer3").click(function() {
		...
		donnees['id_medecin'] = $("#id_medecin").val();
