 ...
 */	
	...
	public function consultationMedecinAction() {
		...
		$lespatients = $this->getConsultationTable()->listePatientsAdmis();
		//RECUPERER TOUS LES PATIENTS AYANT UN RV aujourd'hui
		//$tabPatientRV = $this->getConsultationTable ()->getPatientsRV($idService);
		...
		return new ViewModel ( array (
				'patientsAdmis' => $lespatients[0],
				'patientsConsultes' => $lespatients[1],
				'tabPatientRV' => null,
		) );
	}
	...
	public function complementConsultationAction() {
		...
		$tabPatientRV = array(); //$this->getConsultationTable()->getPatientsRV($IdDuService);
		$resultRV = null;
		/*
		if(array_key_exists($id_pat, $tabPatientRV)){
			$resultRV = $tabPatientRV[ $id_pat ];
		...
		*/
		...
		$data = array (
				...
				'id_patient' => $id_pat,
				'date_cons' => null,
				'poids' => null, //$consult->poids,
				'taille' => null, //$consult->taille,
				'temperature' => null, //$consult->temperature,
				'pouls' => null, //$consult->pouls,
				'frequence_respiratoire' => null, //$consult->frequence_respiratoire,
				'glycemie_capillaire' => null, //$consult->glycemie_capillaire,
				'pressionarterielle' => null, //$consult->pression_arterielle,
				'hopital_accueil' => null, //$idHopital,
		...
		// Pour recuper les bandelettes
		$bandelettes = array('temoin'=>0); //$this->getConsultationTable ()->getBandelette($id);
		...
		$dateActu = (new \DateTime())->format('Y-m-d');
		$heureActu = (new \DateTime())->format('H:i');
		...
		return array (
				...
				'image' => $image,
				'form' => $form,
				'heure_cons' => $heureActu, //$consult->heurecons,
				'dateonly' => $dateActu, //$consult->dateonly,
	...
	public function updateComplementConsultationAction(){
		...
		//mettre a jour la consultation
		$this->getConsultationTable ()->addConsultation ( $form, $id_medecin );
